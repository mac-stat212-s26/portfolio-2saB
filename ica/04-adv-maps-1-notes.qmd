...
mn_cities <- st_read("../data/04-adv-maps/shp_loc_pop_centers/")
mn_water <- st_read("../data/04-adv-maps/shp_loc_pop_centers/")
```
...
transform_and_plot <- function(spatial_obj, new_crs, new_title) {
    spatial_obj |> 
...
transform_and_plot(nc, new_crs = "EPSG:32133", new_title = "North Carolina")

# Random1 
transform_and_plot(nc, new_crs = "EPSG:26992", new_title = "North Carolina 2")

# Random2
transform_and_plot(nc, new_crs = "EPSG:4653", new_title = "North Carolina 3")
